...
import giorgosImage from 'lib/images/giorgos.png'
...
export default function Intro() {
    ...
    return (
        ...
        >
            ...
            <motion.h1
                className="mb-10 mt-4 px-4 text-2xl font-medium !leading-[1.5] sm:text-4xl inli"
                initial={{ opacity: 0, y: 100 }}
                animate={{ opacity: 1, y: 0 }}
            >
                <span className="font-bold block">Hi 👋</span>{" "}
                <span className="font-bold">I'm Giorgos</span>
            </motion.h1>
            <motion.div
